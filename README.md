...
[![PyPI](https://img.shields.io/pypi/v/finaldb)](https://pypi.org/project/finaldb/)
[![CI](https://github.com/gooker_young/finaldb/actions/workflows/ci.yml/badge.svg)](https://github.com/gooker_young/finaldb/actions/workflows/ci.yml)
...
# 运行测试（含覆盖率，阈值 95%）
uv run pytest -m "not slow" --cov=finaldb --cov-fail-under=95
...
使用 tox 在多个 Python 版本（py313）下运行测试：
